...
SimpleForm.setup do |config|
  ...
  config.wrappers :horizontal_form210, tag: 'div', class: 'form-group', error_class: 'has-error' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :pattern
  ...
  config.wrappers :horizontal_file_input210, tag: 'div', class: 'form-group', error_class: 'has-error' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :readonly
  ...
  config.wrappers :password_input, tag: 'div', class: 'form-group', error_class: 'has-error' do |b|
    ...
    b.wrapper tag: 'div', class: 'input-group' do |ba|
      ba.wrapper tag: 'div', class: 'input-group-addon' do |wr|
        wr.wrapper tag: 'span', class: 'glyphicon glyphicon-lock' do |w|
        end
      end
